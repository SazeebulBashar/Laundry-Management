...
<head>
    ...
    <link rel="stylesheet" href="styles/style.css">
     <style>
        body{
            background-image:  url("./images/abucket.jpg");
...
<body>
    <div class="container">
        ...
        if (isset($_POST["submit"])) {
           ...
           if(strlen($address)< 5){
            array_push($errors, "Address is too short");
           }
        ...
        <form action="registration.php" method="post">
            ...
            <p class="d-flex justify-content-end title-tag">The best Desicion for your clothes...</p>
            ...
            <div class="form-btn d-flex">
                ...
                <div style="margin-left:15px; margin-top:10px;"><p>Already Have an Account?<a href="login.php">Login Here</a></p></div>
            </div>
        </form>
        <div>
